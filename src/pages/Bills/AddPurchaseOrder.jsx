      ...
      <div className="mx-auto">
        ...
        <div className="mt-6 bg-white rounded-lg border border-gray-200 p-5 space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-md font-medium text-black mb-2">Seller Party Name</label>
              <select
                ...
                onChange={(e) => {
                  ...
                  setForm((prev) => ({
                    ...prev,
                    sellerPartyName: selectedName,
                    sellerPartyId: selectedParty?.id ? String(selectedParty.id) : "",
                  }));
                }}
